...
<body class="custom-cursor">
    ...
    <nav id="main-nav" class="px-6 md:px-12 lg:px-20">
        <div class="flex items-center justify-between h-20 md:h-24">
            ...
            <div class="hidden md:flex items-center gap-10">
                ...
                <a href="{{ route('gallery.index') }}" class="nav-link {{ request()->routeIs('gallery.*') ? 'active' : '' }}">Galerie</a>
                <a href="{{ route('shop.index') }}" class="nav-link {{ request()->routeIs('shop.*') ? 'active' : '' }}">E-shop</a>
                <a href="{{ route('contact.index') }}" class="nav-link {{ request()->routeIs('contact.*') ? 'active' : '' }}">Kontakt</a>
            </div>

            <!-- Right Icons -->
            <div class="flex items-center gap-6">
                <!-- Cart -->
                <a href="{{ route('cart.index') }}" class="relative" style="color: rgba(245,245,240,0.7); transition: color 0.3s;" onmouseover="this.style.color='#c9a96e'" onmouseout="this.style.color='rgba(245,245,240,0.7)'">
    ...
    <div id="mobile-menu">
        ...
        <a href="{{ route('portfolio.index') }}" class="mobile-nav-link">Portfolio</a>
        <a href="{{ route('gallery.index') }}" class="mobile-nav-link">Galerie</a>
        <a href="{{ route('shop.index') }}" class="mobile-nav-link">E-shop</a>
        <a href="{{ route('exhibitions') }}" class="mobile-nav-link">Výstavy</a>
        <a href="{{ route('press') }}" class="mobile-nav-link">Napsali o mně</a>
        <a href="{{ route('contact.index') }}" class="mobile-nav-link">Kontakt</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.75rem;">
                        <li><a href="{{ route('home') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Domů</a></li>
                        <li><a href="{{ route('portfolio.index') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Portfolio</a></li>
                        <li><a href="{{ route('gallery.index') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Galerie</a></li>
                        <li><a href="{{ route('shop.index') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">E-shop</a></li>
                        <li><a href="{{ route('exhibitions') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Výstavy</a></li>
                        <li><a href="{{ route('press') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Napsali o mně</a></li>
                        <li><a href="{{ route('contact.index') }}" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Kontakt</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.75rem;">
                        <li><a href="{{ route('portfolio.index') }}#portret" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Portréty</a></li>
                        <li><a href="{{ route('portfolio.index') }}#celebrity" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Celebrity</a></li>
                        <li><a href="{{ route('portfolio.index') }}#sport" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Sportovci</a></li>
                        <li><a href="{{ route('portfolio.index') }}#kultura" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Kultura</a></li>
                        <li><a href="{{ route('portfolio.index') }}#politika" style="color: #6b6b6b; font-size: 0.85rem; text-decoration: none; transition: color 0.3s;" onmouseover="this.style.color='#f5f5f0'" onmouseout="this.style.color='#6b6b6b'">Politika</a></li>
                    </ul>
                </div>
